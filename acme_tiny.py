...
def main(argv=None):
    ...
    parser.add_argument("--disable-check", default=True, action="store_true", help="disable checking if the challenge file is hosted correctly before telling the CA")
